package com.example.miniProjet.configSecurity;
...
public class TokenProvider implements Serializable {
    ...
    public String generateToken(Authentication authentication) {
        final String authorities = authentication.getAuthorities().stream()
        	...
        	Employe connectedUser =  employeService.findByUsername(authentication.getName());
        	connectedUser.setPassword(null);
        	connectedUser.setRole(null);
        Map<String, Object> claims = new HashMap<String, Object>();
        claims.put("role", authorities);
        claims.put("employe", connectedUser);
